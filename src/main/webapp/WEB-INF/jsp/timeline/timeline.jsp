		...
		<c:forEach items="${postList}" var="post">
			<div class="container post-box pt-1 pb-3">
				<div class="d-flex justify-content-between align-items-center mb-1">
					<span class="post-id-box font-weight-bold">${post.userId}</span> <img
				...
				<div class="ml-2">
					...
					<div class="post-content-box mb-2">
						<div class="mb-2">
							<span class="mr-2 font-weight-bold">${ post.userId }</span> <span>${ post.content }</span>
						</div>
					</div>
					<div class="comment-list-box">
						<div class="comment-box d-flex justify-content-start">
							...
							<div class="comment-content-box">
								<span class="">댓글내용 Lorem ipsum dolor sit amet
									consectetur adipisicing elit. Ducimus, quo! Odio voluptas nihil
									corrupti quasi magnam voluptates asperiores vel illo itaque
									quod?</span>
							</div>
						...
						<div class="comment-box d-flex justify-content-start">
							...
							<div class="d-flex align-items-center">
								<img src="../static/img/deleteImg.png" class="delete-img" alt=""
									width="13">
							</div>
						</div>
						<div class="comment-form-box form-row align-items-center mt-2">
							<div class="commentInput">
								<input type="text" class="commentInputBox comment-input-box" placeholder="댓글달기">
							</div>
							<div class="">
								<button type="button" class="commentCreateBtn btn btn-sm btn-primary" data-post-id="${post.id}">게시</button>
							</div>
						</div>
					</div>
				</div>
